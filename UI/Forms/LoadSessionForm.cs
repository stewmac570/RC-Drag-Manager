...
using RCDragManagerProd.Repositories; // Assuming RaceSessionRepository is defined here
using RCDragManagerProd.ViewModels; // Assuming RaceSessionSummary is defined here
